...
I built a new Render class to add new DOM nodes, rather than using React for
updating. The original game wrote to the Java console, and the new
implementation copies that pattern by successively adding new nodes to the game
div.
