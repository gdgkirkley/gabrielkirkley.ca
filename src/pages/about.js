      ...
      <TwoCol>
        <div>
          <p>
            ...
            school, I went to{" "}
            <a href="https://ufv.ca" target="_blank" rel="noreferrer noopener">
              UFV
            </a>{" "}
          ...
          <p>
            Over the last three years, I fell in love with and worked my 🍑 off
            to learn everything I can about writing code. That's led me from R
            ...
            which mainly focuses on Java. I owe a huge debt of gratitude to some
            amazing people who share their knowledge on the internet, like{" "}
            <a
          ...
          <p>
            I've also acted, directed, designed, or produced 90+ productions all
          ...
          <p>
            ...
            reading challenge goal (seriously, how do people read 100 books per
            year?!), improving Wikipedia pages on history, growing plants,
            cooking, and building games in Unity. My partner, Paige, and I would
            also desperately love to be cat parents, but... Vancouver.
          </p>
        </div>
      </TwoCol>
    </Layout>
